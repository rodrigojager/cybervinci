...
export declare const FLOW_SERVICE_PATH = "/services/flow";
export declare const LEGACY_FLOW_SERVICE_PATH = "/services/agency-studio";
...
export declare const FlowClient: any;
