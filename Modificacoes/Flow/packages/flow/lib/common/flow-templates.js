...
exports.instantiateFlowWorkflowTemplate = instantiateFlowWorkflowTemplate;
var WORKFLOW_VERSION = 'flow.workflow/v1';
var TEMPLATES = [
    {
...
function instantiateFlowWorkflowTemplate(templateId, options) {
    ...
    return __assign(__assign({}, template.workflow), { id: options.id, name: options.name, description: options.description || template.workflow.description });
}
