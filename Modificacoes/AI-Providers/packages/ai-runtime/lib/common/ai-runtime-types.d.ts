import { CodexProviderCapabilityStatus, CodexProviderInputItem, CodexProviderModelMetadata, CodexProviderNotificationMessage, CodexProviderOptions, CodexProviderRuntime } from '@cybervinci/ai-providers/lib/common';
export type CyberVinciAiReasoningPolicy = 'off' | 'native' | 'virtual' | 'auto' | 'native_plus_virtual_light';
export type CyberVinciAiReasoningEffort = 'none' | 'low' | 'medium' | 'high' | 'xhigh';
export type CyberVinciAiReasoningVariant = string;
export type CyberVinciAiVirtualReasoningMode = 'off' | 'auto' | 'fast' | 'balanced' | 'deep' | 'coding' | 'research' | 'lats';
...
export type CyberVinciAiTaskStreamEvent<TStructured = unknown> = CyberVinciAiTaskStreamTextDelta | CyberVinciAiTaskStreamReasoningDelta | CyberVinciAiTaskStreamNotification | CyberVinciAiTaskStreamComplete<TStructured> | CyberVinciAiTaskStreamError;
...
//# sourceMappingURL=ai-runtime-types.d.ts.map