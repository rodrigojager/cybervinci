...
export interface FlowAgentCatalogRequest extends FlowWorkspaceRequest {
    search?: string;
    category?: string;
    limit?: number;
}

export interface FlowAgentCatalogFileRequest extends FlowWorkspaceRequest {
    catalogId: string;
}

export interface FlowImportAgentCatalogRequest extends FlowWorkspaceRequest {
    catalogId: string;
...
export interface FlowAgentCatalogSummary {
    id: string;
    title: string;
    category: string;
    sourceRelativePath: string;
...
export interface FlowAgentCatalogFile extends FlowAgentCatalogSummary {
    content: string;
}
...
export interface FlowService extends JsonRpcServer<FlowClient> {
    ...
    listAgentCatalog(request: FlowAgentCatalogRequest): Promise<FlowAgentCatalogSummary[]>;
    getAgentCatalogFile(request: FlowAgentCatalogFileRequest): Promise<FlowAgentCatalogFile>;
    importAgentCatalogFile(request: FlowImportAgentCatalogRequest): Promise<FlowAgentMarkdownFile>;
