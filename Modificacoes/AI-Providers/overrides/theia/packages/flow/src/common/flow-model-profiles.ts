import { FlowModelProfile } from './flow-types';

const BUILT_IN_MODEL_PROFILES: FlowModelProfile[] = [
    {
        id: 'inherit',
    ...
    },
    {
        ...
        execution: {
            ...
            virtualReasoning: { enabled: true, mode: 'deep', maxCostMultiplier: 9 }
        },
        tags: ['quality']
    },
    {
    ...
    },
    {
        ...
        execution: {
            ...
            maxTokens: 12000,
            nativeReasoning: { enabled: true, effort: 'medium' },
            virtualReasoning: { enabled: true, mode: 'coding', maxCostMultiplier: 7 }
        },
        tags: ['code']
    },
    {
        id: 'research',
        name: 'Research',
        description: 'Use evidence-aware reasoning for investigation, synthesis, and source-sensitive answers.',
        provider: { providerId: 'theia-language-model' },
        execution: {
            profileId: 'research',
            reasoningPolicy: 'auto',
            ...
            maxTokens: 12000,
            nativeReasoning: { enabled: true, effort: 'medium' },
            virtualReasoning: { enabled: true, mode: 'research', maxCostMultiplier: 6 }
        },
        tags: ['research']
    },
    {
