...
> **CyberVinci local note:** this catalog is stored under `Modificacoes/Skills/Manual/Agency Agents` and must be loaded only after explicit user selection or naming. Do not use it for automatic skill discovery or default agent context.
