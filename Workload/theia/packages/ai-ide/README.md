...
- **OpenCoder Agent**: Provides an open source, provider-neutral coding agent based on the Coder Agent. It reuses Theia AI's model abstraction so products can run it with OpenAI, Anthropic, Ollama, Hugging Face, Llamafile, GitHub Copilot, Codex, Claude Code, and OpenAI-compatible providers.
